  ...
  <div id="about">
    ...
    <div class="main-about">
      ...
      <form action="about.php" method="get"  id="subForm">
        ...
        <div class="confirm lianxi" style="height:50px;width:320px">
          ...
          <a href="javascript:;" id="v_container-a1" style="display: inline-block;margin-right:5px;margin-top:8px;" >换一换</a>
        </div>
